...
// :::::::::: TIMING ::::::::::
//unsigned long previousMillis = 0;  // will store last time Pump relay was updated
//long OnTime = 60000;               // set milliseconds of on-time 
//long OffTime = 3600;               //set milliseconds of off-time
...
void loop() {
  ...
  //:::::::::: LCD/SERIAL CONSOLE ::::::::::
  if ((dist >= 20 || dist <= 0) && (digitalRead(relayPin) == HIGH)) {
    Serial.print(dist);
    Serial.println("cm - out of range ");
    Serial.println("PUMP: OFF");
    lcdSensorOut();

  } else if ((dist <= 10) && (digitalRead(relayPin) == HIGH)) {
    Serial.print(dist);
